<div class="fullpaper">
	<div class="row">
		<div class="col-md-6"><?php echo <<<html
			<h4 style="display: inline-block;">Online exam of subjects</h4> $courseData[code] $courseData[name]<br>
			<p style="padding-left: 10px">
				<b><u>The description</u></b><br>
				$paperData[description]<br>
				<b><u>Explanation / Exam rules</u></b>
				<br> $paperData[rules]
			</p>
html;
?>		</div>
...
html;
		...
		{
			echo '<div class="row">
				<div class="col-md-12 text-right"><a href="#next" class="btn btn-info btn-sm">Next page</a>
			</div>
			</div>';
		}
		echo '
...
?>
	...
	<div class="row" style="padding-top: 30px">
		...
		<?php
			if ($useForm)
			{
				echo form_submit('submit', 'Send exam', 'class="btn btn-primary"');
				echo form_close();
			}
		?>
		</div>
